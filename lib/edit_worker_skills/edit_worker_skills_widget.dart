...
import 'edit_worker_skills_model.dart';
export 'edit_worker_skills_model.dart';

class EditWorkerSkillsWidget extends StatefulWidget {
  const EditWorkerSkillsWidget({
    Key? key,
    this.workerUserRef,
    this.workerSkillsRef,
  }) : super(key: key);

  final DocumentReference? workerUserRef;
  final DocumentReference? workerSkillsRef;

  @override
  _EditWorkerSkillsWidgetState createState() => _EditWorkerSkillsWidgetState();
}

class _EditWorkerSkillsWidgetState extends State<EditWorkerSkillsWidget>
    with TickerProviderStateMixin {
  late EditWorkerSkillsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditWorkerSkillsModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<WorkersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<WorkersRecord> editWorkerSkillsWorkersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final editWorkerSkillsWorkersRecord =
            editWorkerSkillsWorkersRecordList.isNotEmpty
                ? editWorkerSkillsWorkersRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          ...
          appBar: AppBar(
            ...
            title: Text(
              FFLocalizations.of(context).getText(
                'nuaxpsar' /* Edit Skills and Experience */,
              ),
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    final workerSkillsUpdateData =
                                        createWorkerSkillsRecordData();
                                    await widget.workerSkillsRef!
                                        .update(workerSkillsUpdateData);
                                  },
                                ...
                                children: [
                                  StreamBuilder<List<WorkerSkillsRecord>>(
                                    stream: queryWorkerSkillsRecord(
                                      parent: editWorkerSkillsWorkersRecord!
                                          .reference,
                                      singleRecord: true,
                                    ),
                                    builder: (context, snapshot) {
                                  ...
                                  Padding(
                                    ...
                                    child: FlutterFlowDropDown<String>(
                                      options: [
                                        ...
                                        FFLocalizations.of(context).getText(
                                          '5dgb3k6c' /* Minning work */,
                                        ),
                                        FFLocalizations.of(context).getText(
                                          'expd7343' /* Load bearer */,
                                        ),
                                        FFLocalizations.of(context).getText(
                                          'q2q71fdc' /* Assambling */,
                                        ),
                                        ...
                                        FFLocalizations.of(context).getText(
                                          'dil4qrt0' /* 4 Wheel Driver */,
                                        ),
                                        FFLocalizations.of(context).getText(
                                          'ppmt3kf8' /* 8 Wheel Driver */,
                                        ),
                                        FFLocalizations.of(context).getText(
                                          'mkuqbgd7' /* 12 Wheel Driver */,
                                        ),
                                        FFLocalizations.of(context).getText(
                                          '3aizovyw' /* others */,
                                        )
                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              await editWorkerSkillsWorkersRecord!.reference
